...
//	private static final String IP_FILE = IPSeeker.class.getResource("E:/workspace/ip-resource/res/qqwry.dat").toString().substring(5);
	private static final String IP_FILE = "./config/ipdata.dat";
	...
	private IPSeeker() {
		...
		try {
			...
			System.out.println(IPSeeker.class.getResource("/ipdata.dat").toString());
