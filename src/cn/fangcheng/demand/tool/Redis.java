...
public class Redis implements CursorInter {
	 ...
	 * @param 超时时间
	 */
	public Redis(String ip, int maxActive, int minIdle, int timeout, int PoolTimeOut) {
		...
		// 127.0.0.1:6379
		pool = new JedisPool(config, ip.split(":")[0], Integer.parseInt(ip.split(":")[1]), PoolTimeOut);
	}
