 ...
 *
 */
public class CustomMallScoresBean {
	 ...
	 * mall面积 处理后
	 */
	public double mallFloorSize=0;
	/**
	 * 停车位数量 处理后
	 */
	public double mallParking=0;
	/**
	 * 是否存在点评
	 */
	public int spiderChannelScore=0;
	...
	public double getMallFloorSize() {
		return mallFloorSize;
	}
	public void setMallFloorSize(double mallFloorSize) {
		this.mallFloorSize = mallFloorSize;
	}
	public double getMallParking() {
		return mallParking;
	}
	public void setMallParking(double mallParking) {
		this.mallParking = mallParking;
	}
	public int getSpiderChannelScore() {
		return spiderChannelScore;
	}
	public void setSpiderChannelScore(int spiderChannelScore) {
		this.spiderChannelScore = spiderChannelScore;
	}
