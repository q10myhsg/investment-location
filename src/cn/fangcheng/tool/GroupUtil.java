...
public class GroupUtil{
	 ...
	 * @param name
	 */
	public static BasicDBObject query(String utime){
		//完全匹配
		...
		//Pattern pattern = Pattern.compile("^name.*$", Pattern.CASE_INSENSITIVE);
		//模糊匹配
		Pattern pattern = Pattern.compile("^.*"+utime+".*$", Pattern.CASE_INSENSITIVE);
		BasicDBObject query = new BasicDBObject();
		query.put("demand_ctime",pattern);
		query.put("demand_status",new BasicDBObject(QueryOperators.NE,0));
		return query;
	}
	/**
	 ...
	 * @return key 对象
	 */
	public static DBObject generateFormulaKeyObject(HashMap<String,String> dimMap){
	 ...
	 * @return key 对象
	 */
	public static DBObject generateFormulaInitObject(HashMap<String,String> indexMap){
	 ...
	 * @return reduce函数
	 */
	public static String generateFormulaReduceObject(HashMap<String,String> indexMap){
	 ...
	 * @return reduce函数
	 */
	public static String generateFormulaFinalizeObject(HashMap<String,String> forIdxMap, HashMap<String,String> indexMap){
		StringBuffer reduceBuf = new StringBuffer();
		reduceBuf.append("function(doc){");
		//得到计算指标的公式运行值
		Iterator<String> formulaIt = forIdxMap.keySet().iterator();
		while (formulaIt.hasNext()){
			String indexId = formulaIt.next();
			String idxFormula = forIdxMap.get(indexId);
